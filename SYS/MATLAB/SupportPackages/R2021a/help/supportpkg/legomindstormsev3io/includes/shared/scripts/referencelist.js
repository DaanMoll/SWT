var referenceListType = 'saxonjs'; // 'saxonjs' or 'lucene'
if (window.location.href.startsWith('file:')) {
    // For Polyspace Help Browser
    referenceListType = 'lucene';
    }

// Saxon-JS implementation
...
function getProductFilteredReferenceList(mystylesheetLocation, mysourceLocation, product_help_location, top_nav_li, doccentertype, langcode) {
    ...
    requestHelpService({}, services,
        function(data) {
            ...
            }); // Consider adding 'async' as 2nd argument. Reference: http://saxonica.com/saxon-js/documentation/index.html#!api/transform/execution
